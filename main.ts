...
let fruits : string[] = ["apple","banana","mango","orange"]; // declared array as fruits and assigned values as apple banana mango and orange
console.log(fruits);
...
let numbers : number[] = [10,20,30,40]; // declared array as numbers and assigned values as 10 20 30 and 40
console.log(numbers);
...
let thirdFruit = fruits[2];// third element of array assigned to variable thirdFruit 
...
let lastFruit = fruits.pop();// pop method removes last element of array and return removed element
...
let firstFruit = fruits.shift();// shift method removes first element from array and return removed element
